        ...
        <div className="container mx-auto">
          ...
          <div className="max-w-3xl mx-auto mt-10 p-4 bg-blue-50 rounded-lg border border-blue-100 rtl">
            ...
            <ol className="font-arabic list-decimal list-inside space-y-2 text-gray-700">
              ...
              <li>يمكنك تخصيص ألوان العناوين من تبويب "الإعدادات".</li>
            ...
            <ul className="font-arabic list-disc list-inside space-y-2 text-gray-700">
              <li>العناوين الرئيسية: خط كوفي، وسط الصفحة (يمكن تخصيص اللون)</li>
              <li>العناوين الفرعية: خط كوفي، محاذاة لليمين (يمكن تخصيص اللون)</li>
              <li>العناوين الفرعية الثانوية: خط كوفي، محاذاة لليمين (يمكن تخصيص اللون)</li>
